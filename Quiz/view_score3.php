...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        $sql = "SELECT name,q1, q2, q3, q4, q5 FROM student3 WHERE rollno = '$rollno'";
        ...
        if ($result->num_rows > 0) {
            ...
            // Update the 'mark' column in the 'student3' table with the calculated total marks
            $updateSql = "UPDATE student3 SET mark = '$totalMarks' WHERE rollno = '$rollno'";

...
<body>
  <div class="form-container">
    <?php
      ...
      echo "Class 1";
      // Display the form for Class 1
      echo "<form id='quizForm' method='post' action='one2.php'>";
      echo "<div class='question-container active'>";
      echo "<p>Question 1: What is 4 + 5 ?</p>";
      echo "<input type='text' name='q1'><br>";
      echo "</div>";
      echo "<div class='question-container'>";
      echo "<p>Question 2: What is 5 + 9 ?</p>";
      echo "<input type='text' name='q2'><br>";
      echo "</div>";
      echo "<div class='question-container'>";
      echo "<p>Question 3: What is 3 + 5 ?</p>";
      echo "<input type='text' name='q3'><br>";
      echo "</div>";
      echo "<div class='question-container'>";
      echo "<p>Question 4: What is 5 + 5 ?</p>";
      echo "<input type='text' name='q4'><br>";
      echo "</div>";
      echo "<div class='question-container'>";
      echo "<p>Question 5: What is 7 + 4 ?</p>";
      echo "<input type='text' name='q5'><br>";
      echo "</div>";
      echo "<input type='hidden' name='class' value='1'>";

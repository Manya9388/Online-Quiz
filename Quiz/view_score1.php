...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        $sql = "SELECT name,q1, q2, q3, q4, q5 FROM student1 WHERE rollno = '$rollno'";
        ...
        if ($result->num_rows > 0) {
            ...
            // Update the 'mark' column in the 'student1' table with the calculated total marks
            $updateSql = "UPDATE student1 SET mark = '$totalMarks' WHERE rollno = '$rollno'";

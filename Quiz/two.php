...
<body>
  <div class="form-container">
    <?php
      ...
      echo "<form id='quizForm2' method='post' action='two2.php'>";
      echo "<div class='question-container active'>";
      echo "<p>Question 1: What is 14 + 5 ?</p>";
      echo "<input type='text' name='q1'><br>";
      echo "</div>";
      echo "<div class='question-container'>";
      echo "<p>Question 2: What is 15 + 9 ?</p>";
      echo "<input type='text' name='q2'><br>";
      echo "</div>";
      echo "<div class='question-container'>";
      echo "<p>Question 3: What is 13 + 5 ?</p>";
      echo "<input type='text' name='q3'><br>";
      echo "</div>";
      echo "<div class='question-container'>";
      echo "<p>Question 4: What is 15 + 5 ?</p>";
      echo "<input type='text' name='q4'><br>";
      echo "</div>";
      echo "<div class='question-container'>";
      echo "<p>Question 5: What is 17 + 4 ?</p>";
